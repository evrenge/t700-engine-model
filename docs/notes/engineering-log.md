...
The narrative record of how this replication reached its numbers: what was wrong, how it was
found, and what each correction moved. It lived in `README.md` until 2026-09-14, where it had
grown to 280 lines under a heading that said "Known gaps" -- which was wrong twice over, since
most of it describes defects that were **found and fixed**, and most of those were ours rather
than the report's.

It is kept because it is the project's evidence. A number in `README.md` or in `site/` is worth
what the work behind it is worth, and this is that work. Read `docs/notes/open-questions.md` for
what is still *open*; this file is what is closed and how.

Entries are in the order they appeared, not chronological order.
...
## The transient, and the four things that were wrong with it
