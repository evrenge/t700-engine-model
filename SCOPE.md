...
| Whole-curve RMS, normalised by each panel's excursion | **4 % ratchet** | `test_whole_curve.WHOLE_CURVE_RMS_CEILING_PCT`. Not a tolerance -- set just above the worst measured panel so a regression fails and an improvement is free. Current over ten panels, **riser excluded**: mean **1.677 %**, worst **3.820 %** (Figure 10 T41), range 0.673-3.820. Figure 9's best two panels are TORQ45 at 0.673 and T41 at 0.706, and every Figure 9 panel is under 1.5 %. (This line said "Figure 9's T41 and T45 are the best two at 0.706 and 0.836" until 2026-09-14; TORQ45 at 0.673 is better than both, and the table it was drawn from says so two rows down.) It went 17 -> 8 -> 14 -> 8 -> 5 -> **4**; three of the last four moves were corrections to our own measurement rather than to the model, and the full history is in that symbol's docstring |
